  ...
  const doLogIn = (credentials) => {
    API.logIn(credentials)
      ...
      .catch(err => {
        ...
        if(err.toString() == 'TypeError: Failed to fetch.' || err.toString() == 'TypeError: NetworkError when attempting to fetch resource.'){
          setErrorMessage('Server error: '+'"'+err.toString()+'"'); // Do informazioni aggiuntive solo nel caso in cui la fetch fallisce (server non disponibile presumibilmente)
        }else{
